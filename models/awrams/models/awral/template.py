...
_HEADER_T_FN = os.path.join(_FILE_PATH,'core',"awral_t.h")
_SOURCE_T_FN = os.path.join(_FILE_PATH,'core',"awral_t.c")
_HEADER_FN = os.path.join(_FILE_PATH,'core',"awral.h")
_SOURCE_FN = os.path.join(_FILE_PATH,'core',"awral.c")
_LIB_FN = os.path.join(_FILE_PATH,'core',"awral.so")
