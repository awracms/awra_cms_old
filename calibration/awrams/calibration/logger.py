...
class CalibrationLoggerProcess(Process):
    def __init__(self,parameters,local_ids,filename,lschema,gschema,opt_meta=None):
        super().__init__()
        self.msg_in = Queue()
    ...
    def run(self):
        self.logger = CalibrationLogger(self.parameters,self.local_ids,self.filename,self.lschema,self.gschema,self.opt_meta)
