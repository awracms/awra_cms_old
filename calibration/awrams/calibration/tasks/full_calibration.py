...
def get_task_specification():
    ...
    optimizer_spec = OptimizerSpec(sce.ShuffledOptimizer,evolver_spec=evolver_spec,n_complexes=2,max_nsni=1000,min_complexes=1,max_eval=300) #n_complex 14
    ...
    cal_spec['logfile'] = '/home/dshipman/calres.h5'
